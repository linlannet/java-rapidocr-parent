...
基于RapidOcr的java引擎，可通过此工程实现图片ocr识别，并将基于选择模板数据封装为API接口提供给外部应用访问


## 版本历史
```
1.0.2   2026-05-06      arm64的ncnn版本更新，删除onnx文件，暂时未找到对应的so文件

1.0.1   2025-06-27      arm64的版本升级为1.2.3
1.0.1   2025-06-25      rapidocr资源增加两个包：ncnn的linux-arm64和onnx的linux-arm64
